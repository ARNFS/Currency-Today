...
class HomeViewController: UIViewController {
    ...
    func configure(){
        models.append(contentsOf: [
            ...
            CourseOption(name: "TJS", currency: "Tajikistan", backgroundimage: UIImage(named: "images")!, backgroundcolor: .systemTeal, course: "1"),
            CourseOption(name: "UZS", currency: "Uzbekistan", backgroundimage: UIImage(named: "gg")!, backgroundcolor: .systemTeal, course: "1"),
            CourseOption(name: "KGS", currency: "Kyrgyzstan", backgroundimage: UIImage(named: "kyrg")!, backgroundcolor: .systemTeal, course: "1"),
            CourseOption(name: "MDL", currency: "Moldova", backgroundimage: UIImage(named: "gago")!, backgroundcolor: .systemTeal, course: "1"),
            CourseOption(name: "SEK", currency: "Sweden", backgroundimage: UIImage(named: "sek")!, backgroundcolor: .systemTeal, course: "1"),
        ])
    }
