...
class ChangeViewController: UIViewController {
    ...
    func configure(){
        models.append(contentsOf: [
            ...
            ChangeOption(name: "TJS", backgroundColor: .systemTeal, backgroundImage: UIImage(named: "images")!, api: "https://open.er-api.com/v6/latest/TJS"),
            ChangeOption(name: "UZS", backgroundColor: .systemTeal, backgroundImage: UIImage(named: "gg")!, api: "https://open.er-api.com/v6/latest/UZS"),
            ChangeOption(name: "KGS", backgroundColor: .systemTeal, backgroundImage: UIImage(named: "kyrg")!, api: "https://open.er-api.com/v6/latest/KGS"),
            ...
            ChangeOption(name: "MDL", backgroundColor: .systemTeal, backgroundImage: UIImage(named: "gago")!, api: "https://open.er-api.com/v6/latest/MDL"),
            ChangeOption(name: "SEK", backgroundColor: .systemTeal, backgroundImage: UIImage(named: "sek")!, api: "https://open.er-api.com/v6/latest/SEK"),
